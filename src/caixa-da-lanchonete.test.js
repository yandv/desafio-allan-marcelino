...
describe('CaixaDaLanchonete', () => {
    ...
    ])('compra de combos em %p deve resultar em %p', validaTeste);

    test.each([
        ['chantily', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['combo2', 'chantily,1']],
        ['queijo', 'credito', 'Item extra não pode ser pedido sem o principal', ['combo2', 'queijo,1']],
        ['chantily com outro item', 'credito', 'Item extra não pode ser pedido sem o principal', ['combo2', 'chantily,1', 'sanduiche,1']],
        ['queijo com outro item', 'debito', 'Item extra não pode ser pedido sem o principal', ['combo2', 'cafe,1', 'queijo,1']],
    ])('compra de combo %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
    ...
    ])('compra de múltiplas combo quantidades em %p deve resultar em %p', validaTeste);
